...
def write_results_to_file(test_results_dict, results_json_file, test_summary, summary_file):
    """
    Writes test results files, to be read by FLASK app
    :param test_results_dict: dictionary with test data
    :param results_json_file: file to write dictionary to
    :param test_summary: test results in table format
    :param summary_file: file to write table to
    """
    try:
